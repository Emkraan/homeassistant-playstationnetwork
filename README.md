...
<img src="https://raw.githubusercontent.com/Emkraan/ha-playstation-network/main/.github/ha-playstation-network.png" alt="PlayStation Network" width="256"/>
...
[![GitHub release](https://img.shields.io/github/v/release/Emkraan/ha-playstation-network)](https://github.com/Emkraan/ha-playstation-network/releases)
[![HA Version](https://img.shields.io/badge/Home%20Assistant-2024.1.0%2B-blue)](https://www.home-assistant.io/)
[![License](https://img.shields.io/github/license/Emkraan/ha-playstation-network)](LICENSE)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=Emkraan&repository=ha-playstation-network&category=integration)

1. Click the badge above, or open HACS → Integrations → ⋮ → Custom repositories
2. Add `https://github.com/Emkraan/ha-playstation-network` as an **Integration**
